      ...
      <div className='about-container'>
        <div className='about-context'>
          ...
          <Text className='about-text'>
            Hello! My name's Xavier and I enjoy bringing things to life with code. I got my start in web development in 2020 when I learned Python through Stanford's Code in Place course. I fell in love with the process and started tinkering with HTML, CSS, and JavaScript. After a few months of self-teaching, I decided to take the plunge and enroll in a coding bootcamp. I graduated from Code Fellows in 2022 with a certificate in Advanced Software Development with Full-Stack JavaScript. Some of the technologies that I've been working with recently include:
          </Text>
